...
def retrieve_relevant_passage(query_embedding, top_k=3):
...
def main():
    print("🔍 Ask a question about any VC firm:")
    while True:
        query = input("> ").strip()
        if not query:
            print("Exiting.")
        ...
        print("📚 Retrieving relevant VC documents...")
        top_chunks = retrieve_relevant_passage(query_embedding)
